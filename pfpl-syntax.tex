  ...
  \begin{small}
    \begin{displaymath}
      \begin{array}{l@{\qquad}l@{\qquad}l@{\qquad}l}
        ...
        \vprojEx<I><i>[\tau]{e}           & \vprojEx*<I><i>{e}          & \verb|\vprojEx<I><i>[\tau]{e}| \quad (i\in I)
      \end{array}
    \end{displaymath}
  \end{small}
  ...
  \begin{small}
    \begin{displaymath}
      \begin{array}{l@{\qquad}l@{\qquad}l@{\qquad}l}
        ...
        \appEx{e_1}{e_2}       & \appEx*{e_1}{e_2}       & \verb|\appEx[\tau_1][\tau_2]{e_1}{e_2}|
      \end{array}
    \end{displaymath}
  \end{small}

  \caption{(Total) Function Types}
  \label{fig:function}
\end{figure}
  ...
  \begin{small}
    \begin{displaymath}
      \begin{array}{l@{\qquad}l@{\qquad}l@{\qquad}l}
        ...
        \seqCmd[\rho_1]{m_1}[\rho_2]{m_2}      & \seqCmd*{m_1}{m_2}          & \verb|\seqCmd[\rho_1]{m_1}[\rho_2]{m_2}| \\
  ...
  \begin{small}
    \begin{displaymath}
      \begin{array}{l@{\qquad}l@{\qquad}l@{\qquad}l}
        ...
        \orEPf[\phi_1][\phi_2][\rho]{\pi}{x}{\pi_1}{x}{\pi_2} & \orEPf*{\pi}{x}{\pi_1}{x}{\pi_2} & \verb|\orEPf[\phi_1][\phi_2][\rho]{\pi}{x}{\pi_1}{x}{\pi_2}| \\[1ex]
