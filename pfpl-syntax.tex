  ...
  \begin{small}
    \begin{displaymath}
      \begin{array}{l@{\qquad}l@{\qquad}l@{\qquad}l}
        ...
        \xcaseEx[\tau_1][\tau_2][\rho]{e}{x_1}{e_1}{x_2}{e_2} & \xcaseEx*{e}{x_1}{e_1}{x_2}{e_2} & \verb|\xcaseEx[\tau_1][\tau_2][\rho]{e}{x_1}{e_1}{x_2}{e_2}| & \\[1ex]
  ...
  \begin{small}
    \begin{displaymath}
      \begin{array}{l@{\qquad}l@{\qquad}l@{\qquad}l}
        ...
        \recthunkEx[\tau]{x}{e}                       & \recthunkEx*[\tau]{x}{e}  & \verb|\recthunkEx[\tau]{x}{e}|   \\
        \forceEx[\negTy{\tau}]{v}                     & \forceEx*{v}              & \verb|\forceEx[\tau]{v}| %\\
        % \copTy{\posTy{\tau_1}}{\negTy{\tau_2}}            & \copTy*{\posTy{\tau_1}}{\negTy{\tau_2}}             & \verb|\copTy{\tau_1}{\tau_2}| \\
        % \copEx[\posTy{\tau_1}][\negTy{\tau_2}]{v_1}{e_2}                          & \copEx*{v_1}{e_2}           & \verb|\copEx[\tau_1][\tau_2]{v_1}{e_2}| \\
