...
The command \verb|\Sub{e}{x}{e'}| expands to $\Sub{e}{x}{e'}$, and \verb|\Sub*{e}{x}{e'}| expands to $\Sub*{e}{x}{e'}$, providing pre- and post-fix notation for substitution.  Substitutions may be written as \verb|\empSub| for the empty substitution, $\empSub$, and \verb|\extSub{\gamma}{x}{e}| for the extension $\extSub{\gamma}{x}{e}$ of a substitution $\gamma$ sending $x$ to $e$, and \verb|\extSub*{\gamma}{x}{e}| for $\extSub*{\gamma}{x}{e}$ written in the opposite order.  A substitution, $\gamma$, is applied to $e$ by writing \verb|\appSub{\gamma}{e}|, which yields $\appSub{\gamma}{e}$, or \verb|\appSub*{\gamma}{e}|, which yields $\appSub*{\gamma}{e}$, codifying two common notational conventions.
