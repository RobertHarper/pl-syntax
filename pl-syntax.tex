...
\begin{figure}
  ...
  \begin{displaymath}
    \begin{array}{l@{\qquad}l@{\qquad}l@{\qquad}l}
      ...
      \lamCn[\kappa_1][u][\kappa_2]{u}{c} & \lamCn*{u}{c} & \verb|\lamCn{u}{c}| \\
      \appCn[\kappa_1][u][\kappa_2]{c}{c_1} & \appCn*[x][x][x]{c}{c_1} & \verb|\appCn{c}{c_1}| \\
      \prodKd{\kappa_1}[u]{\kappa_2} & \prodKd*{\kappa_1}[u]{\kappa_2} & \verb|\prodKd{\kappa_1}[u]{\kappa_2}| \\
      \pairCn[\kappa_1][u][\kappa_2]{c_1}{c_2} & \pairCn*{c_1}{c_2} & \verb|\pairCn{c_1}{c_2}| \\
      \projCn<i>[\kappa_1][u][\kappa_2]{c} & \projCn*<i>{c} & \verb|\projCn<i>{c}|
      \end{array}
  \end{displaymath}
